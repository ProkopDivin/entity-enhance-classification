...
def summarize_combination(
    *,
    ...
    return {
        ...
        'Loss_std': float(df['Loss'].std(ddof=1)),
        'F1_macro_relevant_mean': float(df['F1_macro_relevant'].mean()),
        'F1_macro_relevant_std': float(df['F1_macro_relevant'].std(ddof=1)),
        'Precision_macro_relevant_mean': float(df['Precision_macro_relevant'].mean()),
        'Precision_macro_relevant_std': float(df['Precision_macro_relevant'].std(ddof=1)),
        'Recall_macro_relevant_mean': float(df['Recall_macro_relevant'].mean()),
        'Recall_macro_relevant_std': float(df['Recall_macro_relevant'].std(ddof=1)),
        'F1_micro_mean': float(df['F1_micro'].mean()),
        'F1_micro_std': float(df['F1_micro'].std(ddof=1)),
        'Precision_micro_mean': float(df['Precision_micro'].mean()),
        'Precision_micro_std': float(df['Precision_micro'].std(ddof=1)),
        'Recall_micro_mean': float(df['Recall_micro'].mean()),
        'Recall_micro_std': float(df['Recall_micro'].std(ddof=1)),
    }
